...
// let sortedPeople1 = people.sort(function (a, b) {
//   return b.age - a.age;
// });
...
// let sortedPeople2 = people.sort(function (a, b) {
...
// let sortedPeople3 = people.sort(function (a, b) {
...
// prettier-ignore
let sortedPeople4 = people.sort(function (a, b) {
  return a.hobbies.length === b.hobbies.length ? 
  a.name > b.name ? 1 : -1 :
  a.hobbies.length > b.hobbies.length ? 1 : -1 ;
});
console.log(sortedPeople4);
